...
public final class DeletarUsuarioUseCaseImpl implements DeletarUsuarioUseCase {

    private final UsuarioRepository usuarioRepository;
    private final BuscarUsuarioPorCpfUseCase buscarUsuarioPorCpfUseCase;

    public DeletarUsuarioUseCaseImpl(UsuarioRepository usuarioRepository, BuscarUsuarioPorCpfUseCase buscarUsuarioPorCpfUseCase) {
